package com.arslan.invitationapp.invitationapp.configuration;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    private IUserDetailService m_userDetailService;
    private AuthEntryPointJwt m_unauthorizedHandler;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                .exceptionHandling().authenticationEntryPoint(m_unauthorizedHandler).and()
